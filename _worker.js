...
const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'gcore.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)];

let dohURL = 'https://dns-doh.milik-fukada.eu.org/1:wAYCAA4hAQAIwA=='; // https://cloudflare-dns.com/dns-query or https://dns.google/dns-query
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const hostnames = ['milik-fukada.eu.org', 'byteblaster.link', 'v2ray69.milik-fukada.eu.org', 'hah.milik-fukada.eu.org'];
